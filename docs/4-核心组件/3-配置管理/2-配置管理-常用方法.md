...
- 说明： `GetAdapter` 方法是获取当前运行的 `gcfg` 适配器信息，关于适配器相关，可以请点击 [配置管理-接口化设计](https://goframe.org/docs/核心组件/配置管理/配置管理-接口化设计)
- 格式：
...
- 说明： `SetAdapter` 方法是设置当前运行的 `gcfg` 适配器信息，关于适配器相关，可以请点击 [配置管理-接口化设计](https://goframe.org/docs/核心组件/配置管理/配置管理-接口化设计)
- 格式：
