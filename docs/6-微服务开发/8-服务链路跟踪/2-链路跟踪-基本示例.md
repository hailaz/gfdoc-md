...
![](/download/attachments/3673727/image2021-1-29_1-7-27.png?version=1&modificationDate=1611853647903&api=v2)

打开 `Jaeger UI`: [http://localhost:16686/search](http://localhost:16686/search)，可以看到链路追踪的结果：![](/download/attachments/3673727/16d37797d34b4a5f.jpg?version=1&modificationDate=1611840105891&api=v2)

![](/download/attachments/3673727/image2021-1-29_1-9-1.png?version=1&modificationDate=1611853741956&api=v2)

点击详情可以查看具体信息，包括 `span` 的调用顺序、调用关系，执行时间轴，以及记录一些Attributes和 `Events` 信息，极大的方便我们定位系统中的异常和发现性能瓶颈。：

![](/download/attachments/3673727/image2021-1-29_10-11-11.png?version=1&modificationDate=1611886272005&api=v2)
