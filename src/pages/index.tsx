...
function HomepageHeader() {
  ...
  return (
    <header className={clsx('hero hero--primary', styles.heroBanner)}>
      ...
      <p><img decoding="async" loading="lazy" alt="GoFrame#auto#100px#center" src="/gfdoc-md/assets/images/logo2-dea44e9a74af1387f11f2ede68bd4434.png" width="332" height="234" class="img_node_modules-@docusaurus-theme-classic-lib-theme-MDXComponents-Img-styles-module"/></p>
